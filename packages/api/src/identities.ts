...
export const FAST_START_LIBRARY_KIND = "tcb-fast-start-library" as const;
export const CHARACTER_LOAD_KIND = "tcb-character-load" as const;
 ...
 */
export const SNAPSHOT_PARSER_VERSION = "8";
